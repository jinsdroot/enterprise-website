<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpJobList.aspx.cs" Inherits="jsbestop.Web.Manager.JobManager.cpJobList" %>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlJobType" CssClass="input_ctrl" runat="server" Width="230px">
                                    </asp:DropDownList>
                                </td>
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpJobDetails.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="岗位类别">
                                <ItemTemplate>
                                    <%#GetJobTypeName(Convert.ToInt32(Eval("JobTypeID")))%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="岗位名称">
                                <ItemTemplate>
                                    <%#GetStrByByteLength(Eval("JobName").ToString(), 60, true)%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="35%" />
                                <ItemStyle CssClass="cbitem" Width="35%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="招聘人数">
                                ...
                                <HeaderStyle CssClass="header" Width="5%" />
                                <ItemStyle CssClass="lblitem" Width="5%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="修改">
                                <HeaderStyle CssClass="header" Width="10%" />
                                <ItemStyle CssClass="cbitem" Width="10%" />
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpJobDetails.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
