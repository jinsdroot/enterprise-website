<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpJobTypeDetail.aspx.cs" Inherits="jsbestop.Web.Manager.JobManager.cpJobTypeDetail" %>
...
<head runat="server">
   <title></title>
    ...
    <script type="text/javascript">
        function checkUI() {
            var sm = document.getElementById("<%=txtJobTypeName.ClientID %>");
            if (sm != null) {
                if (sm.value.trim() == "") {
                    alert("请输入岗位类别名称");
                    return false;
...
<body>
   ...
   <asp:ScriptManager ID="sm1" runat="Server" EnablePageMethods="true" /> 
	...
	<div class="percent">
        <div id="nav">
            <div class="nav_left">
                <asp:Label ID="lblNav" Text="岗位类别详细" runat="Server" /></div>
            <div class="nav_right">
            </div>
        </div>
        <table border="0" cellpadding="0" cellspacing="1" class="tbl_form">     
            ...
            <tr>
                ...
                <td class="td_ctrl" width="80%"  align="left">                    
                    <asp:TextBox ID="txtJobTypeName" runat="server" Width="230px" CssClass="input_ctrl"></asp:TextBox>	
                </td>
            </tr>           
             <tr>
                <td class="td_label" style="width: 13%; height: 25px;">
        ...
        <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpJobTypeList.aspx';" />
                </td></tr>
        </table>
