<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpProductDetail.aspx.cs"
    Inherits="jsbestop.Web.Manager.ProductManager.cpProductDetail" %>
        ...
        <tr>
            <td width="98%" align="center">
                <div class="percent">
                    <div id="nav">
                        <div class="nav_left">
                            <asp:Label ID="lblNav" Text="产品展示" runat="Server" /></div>
                        <div class="nav_right">
                        </div>
                    </div>
                    <table border="0" cellpadding="0" cellspacing="1" class="tbl_form">
                        ...
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:RadioButton ID="rbthasPhone" runat="server" Text="有" GroupName="IsPhone" Checked="true"/>
                                <asp:RadioButton ID="rbtnoPhone" runat="server" Text="无" GroupName="IsPhone"  />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:TextBox ID="txtProName" runat="server" CssClass="input_ctrl" Width="210px"></asp:TextBox>
                            </td>
                        </tr>
                        <%--<tr>
                            <td class="td_label" style="width: 13%; height: 25px;">
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:TextBox ID="txtProEngName" runat="server" CssClass="input_ctrl" Width="210px"></asp:TextBox>
                            </td>
                        </tr>--%>
                        <tr>
                            <td class="td_label" style="width: 13%; height: 25px;">
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:DropDownList ID="ddlProType" CssClass="input_ctrl" AutoPostBack="true" runat="server"
                                    Width="210px" Height="20px" OnSelectedIndexChanged="ProductType_Change">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:DropDownList ID="ddlProSecondType" Visible="false" CssClass="input_ctrl" runat="server"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="90%">
                        <tr>
                            <td style="background: #fff; text-align: left; padding-left: 150px; padding-top: 10px;
                                ...
                                <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpProductList.aspx';" />
                            </td>
                        </tr>
                    </table>
                </div>
