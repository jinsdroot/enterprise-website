<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpProductSecondTypeList.aspx.cs"
    Inherits="jsbestop.Web.Manager.ProductManager.cpProductSecondTypeList" %>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlProductTypeName" CssClass="input_ctrl" runat="server" Width="230px">
                                    </asp:DropDownList>
                                </td>
                                <td class="search_label" style="width: 150px;">
                                    二级产品类别名称：
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:TextBox ID="txtProductSecondTypeName" CssClass="input_ctrl" Width="230px" runat="server" />
                                </td>
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpProductSecondTypeDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="一级类别名称">
                                <ItemTemplate>
                                    <%#GetProductTypeName(Convert.ToInt32(Eval("ProductTypeID")))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="25%" />
                                <ItemStyle CssClass="cbitem" Width="25%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="二级产品类别名称">
                                <ItemTemplate>
                                    <%#Eval("ProductSecondTypeName")%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="25%" />
                                <ItemStyle CssClass="cbitem" Width="25%" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpProductSecondTypeDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
