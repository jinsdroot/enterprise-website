<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpProductList.aspx.cs"
    Inherits="jsbestop.Web.Manager.ProductManager.cpProductList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowIframe(id) //显示iframe
        {
            ...
            pop.setContent("contentUrl", "cpProductPicBulkUpload.aspx?id=" + id);
            pop.setContent("title", "批量上传图片");
            pop.build();
            pop.show();
        }
    </script>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlCpInforTypeName" CssClass="input_ctrl" runat="server" Width="210px"
                                        Height="20px">
                                    </asp:DropDownList>
                                </td>
                                <td class="search_label" style="width: 150px;">
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlCpInforSecondTypeName" CssClass="input_ctrl" runat="server"
                                        Width="210px" Height="20px">
                                    </asp:DropDownList>
                                </td>
                                <td style="padding: 3px;" colspan="2" align="left">
                                    <asp:ImageButton ID="ImageButton1" ImageUrl="~/Manager/images/search.gif" runat="Server"
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpProductDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="产品名称">
                                ...
                                <HeaderStyle CssClass="header" Width="20%" />
                                <ItemStyle CssClass="lblitem" Width="20%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="产品展示一级类别">
                                <ItemTemplate>
                                    <%#GetProductTypeName(Convert.ToInt32(Eval("ProTypeID")))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="20%" />
                                <ItemStyle CssClass="lblitem" Width="20%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="产品展示二级类别">
                                <ItemTemplate>
                                    <%#GetProductSecondTypeName(Convert.ToInt32(Eval("ProSecondTypeID")))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="20%" />
                                <ItemStyle CssClass="lblitem" Width="20%" />
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="AutoSort" HeaderText="排序字段">
                                <HeaderStyle CssClass="header" Width="5%" />
                                <ItemStyle CssClass="cbitem" Width="5%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="批量上传产品图片">
                                <HeaderStyle CssClass="header" Width="10%" />
                                <ItemStyle CssClass="cbitem" Width="10%" />
                                <ItemTemplate>
                                    <span class="edit">[<a onmouseover="this.style.cursor='hand'" onclick="ShowIframe(<%#Eval("ID")%>);">批量上传</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemStyle CssClass="cbitem" Width="5%" />
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpProductDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
