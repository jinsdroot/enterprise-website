<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpDownLoadDetail.aspx.cs" Inherits="jsbestop.Web.Manager.DownLoadManager.cpDownLoadDetail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function checkUI() {
            var dlnm = document.getElementById("<%=txtDLName.ClientID %>");
            var dl = document.getElementById("<%=UploadDLAddress.ClientID %>");
            var ladl = document.getElementById("<%=lblDLAddress.ClientID %>");
            if (dlnm != null) {
                if (dlnm.value.trim() == "") {
                    alert("请输入文件名称");
                    return false;
                ...
                if (dl != null) {
                    if (dl.value.trim() == "") {
                        if (ladl == '[object HTMLSpanElement]') {
                           alert("请选择文件");
                           return false;
                        }
...
<body>
   ...
   <asp:ScriptManager ID="sm1" runat="Server" EnablePageMethods="true" /> 
	...
	<div class="percent">
        ...
        <table border="0" cellpadding="0" cellspacing="1" class="tbl_form">     
            ...
            <tr>
             ...
             <tr>       
                ...
                <td class="td_ctrl" width="80%"  align="left">                  
                    <asp:FileUpload ID="UploadDLAddress" runat="server" />
                    <asp:Label ID="lblDLAddress" runat="server" ></asp:Label> 
                </td>
        ...
        <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpDownLoadList.aspx';" />
                </td></tr>
        </table>
