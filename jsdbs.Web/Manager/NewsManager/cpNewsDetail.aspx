<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpNewsDetail.aspx.cs" Inherits="jsbestop.Web.Manager.NewsManager.cpNewsDetail" %>
        ...
        <tr>
            <td width="98%" align="center">
                <div class="percent">
                    <div id="nav">
                        <div class="nav_left">
                            <asp:Label ID="lblNav" Text="新闻详细" runat="Server" /></div>
                        <div class="nav_right">
                        </div>
                    </div>
                    <table border="0" cellpadding="0" cellspacing="1" class="tbl_form">
                        ...
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                ...
                                <%--<asp:DropDownList ID="DropDownList1" CssClass="input_ctrl" runat="server" Width="210px" Height="20px">
                                </asp:DropDownList>--%>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:TextBox ID="txtAutoSort" runat="server" onKeyUp="this.value=this.value.replace(/\D/g,'')"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="90%">
                        <tr>
                            <td style="background: #fff; text-align: left; padding-left: 150px; padding-top: 10px;
                                ...
                                <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpNewsList.aspx';" />
                            </td>
                        </tr>
                    </table>
                </div>
