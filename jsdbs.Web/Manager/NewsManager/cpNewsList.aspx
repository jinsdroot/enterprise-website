<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpNewsList.aspx.cs" Inherits="jsbestop.Web.Manager.NewsManager.cpNewsList" %>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlNewsType" CssClass="input_ctrl" runat="server" Width="210px" Height="20px">
                                    </asp:DropDownList>
                                </td>
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpNewsDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="新闻类别">
                                <ItemTemplate>
                                    <%#GetNewsTypeName(Convert.ToInt32(Eval("NewsTypeID")))%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="新闻标题">
                                <ItemTemplate>
                                    <%#GetStrByByteLength(Eval("NewsTitle").ToString(), 60, true)%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpNewsDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
