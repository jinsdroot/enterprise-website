<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpNewsTypeDetail.aspx.cs" Inherits="jsbestop.Web.Manager.NewsManager.cpNewsTypeDetail" %>
...
<body>
   ...
   <asp:ScriptManager ID="sm1" runat="Server" EnablePageMethods="true" /> 
	...
	<div class="percent">
        <div id="nav">
            <div class="nav_left">
                <asp:Label ID="lblNav" Text="新闻类别详细" runat="Server" /></div>
            <div class="nav_right">
            </div>
        </div>
        ...
        <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpNewsTypeList.aspx';" />
                </td></tr>
        </table>
