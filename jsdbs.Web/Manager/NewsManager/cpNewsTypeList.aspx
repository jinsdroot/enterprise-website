<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpNewsTypeList.aspx.cs"
    Inherits="jsbestop.Web.Manager.NewsManager.cpNewsTypeList" %>
                ...
                <div class="percent">
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpNewsTypeDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpNewsTypeDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
