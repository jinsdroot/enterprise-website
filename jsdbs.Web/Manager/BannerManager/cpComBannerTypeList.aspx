<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpComBannerTypeList.aspx.cs"
    Inherits="jsbestop.Web.Manager.BannerManager.cpComBannerTypeList" %>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:TextBox ID="txtNewsTypeName" CssClass="input_ctrl" Width="200px" runat="server" />
                                </td>
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpComBannerTypeDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Banner类别名称">
                                <ItemTemplate>
                                    <%#Eval("ComBannerTypeName")%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpComBannerTypeDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
