<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInformationList.aspx.cs"
    Inherits="jsbestop.Web.Manager.CpInformationManager.CompanyInformationList" %>
                ...
                <div class="percent">
                    ...
                    <div id="search">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td class="search_ctrl" style="width: 210px;">
                                    <asp:DropDownList ID="ddlCompanyInforType" CssClass="input_ctrl" runat="server" Width="210px" Height="20px">
                                    </asp:DropDownList>
                                </td>
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="CompanyInformationDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="公司信息类别">
                                <ItemTemplate>
                                    <%#GetProInforTypeName(Convert.ToInt32(Eval("CompanyInformationTypeID")))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="30%" />
                                <ItemStyle CssClass="lblitem" Width="30%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="公司信息内容">
                                <ItemTemplate>
                                    <%#DelHTML(Eval("CompanyInformationDetail").ToString(),110)%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="45%" />
                                <ItemStyle CssClass="lblitem" Width="45%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="修改">
                                <HeaderStyle CssClass="header" Width="10%" />
                                <ItemStyle CssClass="cbitem" Width="10%" />
                                <ItemTemplate>
                                    <span class="edit">[<a href="CompanyInformationDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
