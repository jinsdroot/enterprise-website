<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInformationTypeList.aspx.cs" Inherits="jsbestop.Web.Manager.CpInformationManager.CompanyInformationTypeList" %>
...
<body>
	...
	<div class="percent">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    ...
                    <td class="search_ctrl" style="width: 210px;">
                        <asp:RadioButton ID="rbtnIsChinese" runat="server" Text="中文" GroupName="IsEnglishLa" Checked="true" OnCheckedChanged="IsEnglishLa_Change"/>
                     <asp:RadioButton ID="rbtnIsEnglish" runat="server" Text="英文" GroupName="IsEnglishLa" OnCheckedChanged="IsEnglishLa_Change"/>
                    </td>
                    <td class="search_label" style="width: 150px;">
                        公司信息类别：</td>
                    <td class="search_ctrl" style="width: 210px;">
                        <asp:TextBox ID="txtCpInforTypeName" CssClass="input_ctrl" Width="200px" runat="server" /></td>                     
		...
		<div class="menu_left">            		 
            ...
            <a href="CompanyInformationTypeDetail.aspx">添加</a>&nbsp;‖&nbsp;
        ...
        <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0" EmptyDataText="未找到相关数据" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="公司信息类别名称" >
                    <ItemTemplate>
                        <%#Eval("CompanyInformationName")%>
                    </ItemTemplate>
                    <HeaderStyle CssClass="header" Width="75%" />
                    <ItemStyle CssClass="lblitem" Width="75%" />
                </asp:TemplateField>				
                <asp:TemplateField HeaderText="修改">
                    <HeaderStyle CssClass="header" Width="10%" />
                    <ItemStyle CssClass="cbitem" Width="10%" />
                    <ItemTemplate>
                       <span class="edit">[<a href="CompanyInformationTypeDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                    </ItemTemplate>
                </asp:TemplateField>
