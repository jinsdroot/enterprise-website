<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpSuccessStoriesList.aspx.cs"
    Inherits="jsbestop.Web.Manager.SuccessStoriesManager.cpSuccessStoriesList" %>
                ...
                <div class="percent">
                    ...
                    <div class="nav">
                        <div class="menu_left">
                            ...
                            <a href="cpSuccessStoriesDetail.aspx">添加</a>&nbsp;‖&nbsp; <a href="javascript:checkSel('删除','<%=grid_friendlink.ClientID %>',7);">
                                批量删除</a>&nbsp;‖&nbsp;
                        </div>
                    </div>
                    <asp:GridView ID="grid_friendlink" AutoGenerateColumns="False" CellSpacing="1" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="成功案例类别">
                                <ItemTemplate>
                                    <%#GetSuccessStoriesTypeName(Convert.ToInt32(Eval("SSType")))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="header" Width="30%" />
                                <ItemStyle CssClass="lblitem" Width="30%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="成功案例标题">
                                <ItemTemplate>
                                    <%#GetStrByByteLength(Eval("SSName").ToString(), 60, true)%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                ...
                                <ItemTemplate>
                                    <span class="edit">[<a href="cpSuccessStoriesDetail.aspx?id=<%#Eval("ID") %>">修改</a>]</span>
                                </ItemTemplate>
                            </asp:TemplateField>
