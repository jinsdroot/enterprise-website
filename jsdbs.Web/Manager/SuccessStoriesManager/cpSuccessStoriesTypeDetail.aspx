<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpSuccessStoriesTypeDetail.aspx.cs"
    Inherits="jsbestop.Web.Manager.SuccessStoriesManager.cpSuccessStoriesTypeDetail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function checkUI() {
            var sm = document.getElementById("<%=txtSSTypeName.ClientID %>");
            if (sm != null) {
                if (sm.value.trim() == "") {
                    alert("请输入成功案例类别名称");
                    return false;
        ...
        <tr>
            <td width="98%" align="center">
                <div class="percent">
                    <div id="nav">
                        <div class="nav_left">
                            <asp:Label ID="lblNav" Text="成功案例类别详细" runat="Server" /></div>
                        <div class="nav_right">
                        </div>
                    </div>
                    <table border="0" cellpadding="0" cellspacing="1" class="tbl_form">
                        ...
                        <tr>
                            ...
                            <td class="td_ctrl" width="80%" align="left">
                                <asp:TextBox ID="txtSSTypeName" runat="server" CssClass="input_ctrl" Width="390px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_label" style="width: 13%; height: 25px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="tbl_form" width="90%">
                        <tr>
                            <td style="background: #fff; text-align: left; padding-left: 150px; padding-top: 10px;
                                ...
                                <input type="button" class="btn" value="返回列表" onclick="javascript:window.location.href='cpSuccessStoriesTypeList.aspx';" />
                            </td>
                        </tr>
                    </table>
                </div>
