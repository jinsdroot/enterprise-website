...
namespace Common
{
    ...
    public static class URLHelper
    {
        ...
        public static string WebURLRoot
        {
            get
            {
                return HttpContext.Current.Request.Url.Scheme.ToString() + "://" + HttpContext.Current.Request.Url.Authority.ToString() + VirtualRoot;
            }
        }
        ...
        /// <returns></returns>
        public static T GetRequestQuery<T>(string key,T defaultValue,Converter<object, T> converter) where T:IConvertible
        {
			try
			{
				return StringPlus.ConverTValue<T>(HttpContext.Current.Request.QueryString[key], defaultValue, converter);
			}
			catch
			{
				return defaultValue;
		...
		/// <param name="defaultValue">错误或异常返回的默认值</param>
		/// <returns></returns>
		public static T GetRequestQuery<T>(string key, T defaultValue) where T : IConvertible
		{
			try
			{
				return StringPlus.ConverTValue<T>(HttpContext.Current.Request.QueryString[key], defaultValue);
			}
			catch
			{
				return defaultValue;
