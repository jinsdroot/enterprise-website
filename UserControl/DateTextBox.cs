...
{
    [ToolboxData("<{0}:DateTextBox></{0}:DateTextBox>")]
    public class DateTextBox : TextBox
    {
        ...
        {
            this.Attributes.Add("onfocus", "calendar()");
        ...
        {
            JavaScriptBuilder js = new JavaScriptBuilder(true);
            ...
            js.AddLine("document.write(\"<iframe name=meizzCalendarIframe scrolling=no frameborder=0 width=151px height=193px></iframe></div>\");");
            ...
            js.AddLine("    \"function document.onkeydown(){ switch(window.event.keyCode){  case 27 : parent.hiddenCalendar(); break;\"+");
            ...
            js.AddLine("    this.iframe     = window.frames(\"meizzCalendarIframe\"); //日历的 iframe 载体");
            js.AddLine("    this.calendar   = getObjectById(\"meizzCalendarLayer\");  //日历的层");
            ...
            js.AddLine("{");
            js.AddLine("    var e = window.event.srcElement;   writeIframe();");
            ...
            js.AddLine("function getObjectById(id){ if(document.all) return(eval(\"document.all.\"+ id)); return(eval(id)); }");
            js.AddLine("function hiddenCalendar(){getObjectById(\"meizzCalendarLayer\").style.display = \"none\";};");
            ...
            js.AddLine("    }");
            js.AddLine("}");
            js.AddLine("function document.onclick()");
            js.AddLine("{");
            js.AddLine("    if(WebCalendar.eventSrc != window.event.srcElement) hiddenCalendar();");
            js.AddLine("}");
